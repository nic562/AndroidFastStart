...
class ActivityTree : ActivityBase(), SomethingTreeListable<Long> {
    ...
    override val listableManager = object : SomethingTreeListable.TreeListableManager<Long>() {
        override fun loadData(page: Int, limit: Int, dataCallback: SomethingTreeListable.OnLoadDataCallback) {
            ...
            dataCallback.onLoadData(data, 50)
        }
    }
